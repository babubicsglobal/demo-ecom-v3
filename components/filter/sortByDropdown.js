...
const SortByDropdown = ({ options, selectedOption, onSelect ,toggleDropdown, isOpen }) => {

    
  return (
    <div className="relative inline-block text-left py-9">
      <div>
        <button
          type="button"
      ...
      {isOpen && ( <div className="absolute z-10 w-full mt-2 bg-white border border-gray-300 rounded-md shadow-lg">
        <ul>
          {options.map((option) => (
            <li
              key={option.value}
